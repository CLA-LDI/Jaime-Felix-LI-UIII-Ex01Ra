					TITLE	Programa para determinar si un número es par o impar utilizando una macro
					PAGE	60, 132

; Incluir las macros
Include Macros.inc

; MacroParImpar para determinar si un número es par o impar
; Parámetros de entrada: Numero
; Parámetros de salida: Resultado
; NOTA: Resultado = 1 es par. Resultado = 0 es impar

MacroParImpar	MACRO	Numero, Resultado
...
MenSal01		WORD	'E', 'l', ' ', 'n', 'ú', 'm', 'e', 'r', 'o', ' ', 'e', 's', ' ', 'p', 'a', 'r', '.'
...
Principal		PROC
				...
				; Llamar la macro para determinar si el número es par o impar
